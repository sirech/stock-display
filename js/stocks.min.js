...
$("#empty a").text(chrome.i18n.getMessage("empty_add"));$("#time_options li").addClass("ui-state-default").click(function(){store("time",$(this).attr("id"));showChart($("#chart").data("id"));return false});if(prepareList()){refresh(app.stocks);window.setInterval(function(){refresh(app.stocks)},3E4)}});
